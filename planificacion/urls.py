...
urlpatterns = [
    ...
    path('menu/agregar-slot/', views.agregar_menu_semanal_slot, name='agregar_menu_semanal_slot'),
    path('menu/content/', views.menu_semanal_content, name='menu_semanal_content'),
    path('menu/filtrar-recetas/', views.filtrar_recetas_categoria, name='filtrar_recetas_categoria'),
    path('menu/remover/<int:pk>/', views.remover_menu_semanal, name='remover_menu_semanal'),
    path('menu/remover-htmx/<int:pk>/', views.remover_menu_semanal, name='remover_menu_semanal_htmx'),
    path('menu/vaciar/', views.vaciar_planificacion, name='vaciar_planificacion'),
    path('menu/repetir-dia/', views.repetir_dia_semana, name='repetir_dia_semana'),
    ...
    path('lista-compra/vaciar/', views.vaciar_lista_compra, name='vaciar_lista_compra'),
